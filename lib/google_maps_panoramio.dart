...
class PanoramioMouseEventListenerAdder extends EventListenerAdder {
  ...
  void add(void handler(PanoramioMouseEvent e)) { super.add((e) => handler(PanoramioMouseEvent.cast(e))); }
  MapsEventListenerRegistration addTemporary(void handler(PanoramioMouseEvent e)) => super.addTemporary((e) => handler(PanoramioMouseEvent.cast(e)));
}